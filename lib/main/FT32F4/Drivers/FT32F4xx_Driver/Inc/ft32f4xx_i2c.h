...
/**
  * @brief  Maximum number of bytes per single I2C transfer
  * @note   Hardware limitation: I2C_CR2.NBYTES is 8-bit register (0xFF = 255)
  *         For transfers > 255 bytes, use RELOAD mode and split into multiple transfers
  */
#define I2C_MAX_TRANSFER_BYTES         255
