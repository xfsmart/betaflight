...
#if defined(FT32F407xx) || defined(FT32F407xe) || defined(FT32F407) || defined(FT32F405xx) || defined(FT32F405) || defined(FT32F4)
  #include "ft32f407xe.h"
#else
 #error "Please select first the target FT32F4xx device used in your application (in ft32f4xx.h file)"
#endif
#include "ft32f4xx_conf.h"
		
//#include "ft32f4xx_hal.h"
/**
  * @}
  */
