/**
  ...
  * @author  			FMD XA
  * @brief   			header file for the usbd_msc_scsi.c
  * @version 			V1.0.0           
  * @data		 			2025-04-28
  ******************************************************************************
  */
 ...
 * @brief This file is Header file for usbd_msc_scsi.c
 * @{
 */


/**@defgroup USBD_MSC_SCSI_Exported_Defines
 * @{
 */
...
/**@defgroup USBD_MSC_SCSI_Exported_TypesDefinitions
 * @{
 */
...
/**@defgroup USBD_MSC_SCSI_Exported_Macros
 * @{
 */
...
/**@defgroup USBD_MSC_SCSI_Exported_Variables
 * @{
 */
...
/**@defgroup USBD_MSC_SCSI_Exported_FunctionsPrototype
 * @{
 */
