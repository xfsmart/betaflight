 ...
 * @brief This file is Header file for usbd_mtp.c
 * @{
 */

/**@defgroup USBD_MTP_CORE_Exported_Defines
 * @{
 */
#ifndef MTP_IN_EP
...
#define USB_MTP_INTERFACE_CLASS                         0x06U
#define USB_MTP_INTERFACE_SUB_CLASS                     0x01U
#define USB_MTP_INTERFACE_PROTOCOL                      0x01U
...
#define MTP_OBJ_FORMAT_JEIF                             0x3808U
...
/**@defgroup USBD_MTP_CORE_Exported_Macros
 * @{
 */
...
/**@defgroup USBD_MTP_CORE_Exported_TypesDefinitions
 * @{
 */
...
typedef struct
{
  ...
  uint8_t  Keywords;
}__attribute__((packed))  MTP_ObjectInfoTypeDef;
...
/**@defgroup USBD_MTP_CORE_Exported_Variables
 * @{
 */
...
/**@defgroup USBD_MTP_CORE_Exported_FunctionsPrototype
 * @{
 */
