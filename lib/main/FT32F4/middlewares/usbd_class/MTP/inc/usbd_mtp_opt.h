/**
  ...
  * @file    			usbh_mtp_opt.h
  * @author  			FMD XA
  * @brief   			Header file for usbh_mtp_opt.c
  * @version 			V1.0.0           
  * @date		 			2025-05-07
  ******************************************************************************
  */
...
#ifndef __USBH_MTP_OPT_H
#define __USBH_MTP_OPT_H
...
/**@addtogroup USBD_MTP_OPT_CLASS
 * @{
 */

/**@defgroup USBD_MTP_OPT
 * @brief This file is Header file for usbd_mtp_opt.c
 * @{
 */

/**@defgroup USBD_MTP_OPT_CORE_Exported_Defines
 * @{
 */
...
#define MTP_OB_PROP_SUBSCRIPTION_CONNECT_ID             0xDC8FU
...
#define MTP_OB_PROP_EMAIL_OTHERS                        0xDDDCU
...
#define MTP_OP_GET_PARITAL_OBJECT                       0x101BU
...
#define MTP_DEV_PROP_WHILE_BALANCE                      0x5005U
...
#define MTP_DEV_PROP_CAPTURE_DEALY                      0x5012U
...
#define MTP_DEV_PROP_PLAYBCAK_RATE                      0xD410U
...
#define MTP_DEV_PROP_PERVEIVED_DEVICE_TYPE              0xD407U
...
/**@defgroup USBD_MTP_OPT_CORE_Exported_TypesDefinitions
 * @{
 */
...
/* request for all object format: storageid, objectformat, objectcompressedsize,
...
} __attribute__((packed)) MTP_FileNameTypeDef;
...
} __attribute__((packed)) MTP_ObjectPropSuppTypeDef;
...
typedef struct
{
  ...
  uint8_t  VolumeLabel;
}__attribute__((packed))  MTP_StorageInfoTypedef;
...
typedef struct
{
  ...
  uint32_t GroupCode;
  uint8_t  FormFlag;
}__attribute__((packed))  MTP_ObjectPropDescTypeDef;
...
typedef struct
{
  ...
  uint16_t Datatype;
  uint8_t  *propval;
}__attribute__((packed)) MTP_PropertiesTypedef;

typedef struct
{
  uint32_t MTP_Properties_len;
  MTP_PropertiesTypedef MTP_Properties[SUPP_OBJ_PROP_LEN];
}__attribute__((packed))  MTP_PropertiesListTypedef;

typedef struct
{
    uint32_t ref_len;
  uint32_t ref[1];
}__attribute__((packed))  MTP_RefTypeDef;
...
typedef struct
{
  ...
  uint16_t curDefValue_len;
  uint16_t curDefValue[DEVICE_PROP_DESC_CUR_LEN];
  uint16_t FormFlag;
}__attribute__((packed))  MTP_DevicePropDescTypeDef;
...
}__attribute__((packed))  MTP_DeviceInfoTypedef;


/**@defgroup USBD_MTP_OPT_CORE_Exported_Macros
 * @{
 */
...
/**@defgroup USBD_MTP_OPT_CORE_Exported_Variables
 * @{
 */
...
/**@defgroup USBD_MTP_OPT_CORE_Exported_Functions
 * @{
 */
