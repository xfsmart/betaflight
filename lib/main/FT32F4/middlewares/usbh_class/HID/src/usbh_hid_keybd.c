/**
  ...
  * @author  			FMD XA
  * @brief   			This file is the application layer for usb host hid keyboard.
  * @version 			V1.0.0           
  * @data		 			2025-04-16
  ******************************************************************************
  *
...
/**@defgroup USBH_HID_KEYBD_Private_TypeDefinitions
 * @{
 */
 ...
 *         The function init the HID keybd.
...
USBH_StatusTypeDef USBH_HID_KeybdInit(USBH_HandleTypeDef *phost)
{
  ...
  else
  {
    USBH_HID_FifoInit(&HID_Handle->fifo, phost->device.Data,
                      (uint16_t)(HID_QUEUE_SIZE * sizeof(keybd_report_data)));
  }
