 ...
 * @brief This file is Header file for usbh_hid.c
 * @{
 */
...
#define HID_ITEM_TYPE_LOACL                   0x02U
...
#define USB_HID_GET_RROTOCOL        0x03U
...
USBH_StatusTypeDef  USBH_HID_SetProtocol(USBH_HandleTypeDef *phost, uint8_t portocol);
