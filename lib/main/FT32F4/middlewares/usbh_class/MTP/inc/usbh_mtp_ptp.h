 ...
 * @brief This file is Header file for usbh_mtp_ptp.c
 * @{
 */
...
#define PTP_RC_IncompleterTransfer                      0x2007U
...
/**@defgroup USBH_MTP_PTP_CORE_Exported_Types
 * @{
 */
typedef enum
{
...
typedef struct
{
  ...
  uint32_t                  transaction_id;     /* ptp transaction id */
  uint32_t                  session_id;         /* ptp session id     */
  uint32_t                  flags;              /* device flags       */
  /* ptp transfer control */
  uint8_t                   *data_ptr;          /* data pointer       */
  uint32_t                  data_length;        /* data length        */
  uint32_t                  data_packet;        /* data packet        */
  uint32_t                  iteration;          /* data iteration     */
  uint32_t                  data_packet_counter;/* packet index       */
  /* object transfer control */
  uint8_t                   *object_ptr;        /* object pointer     */
} PTP_HandleTypeDef;
...
#define PTP_OFC_MTP_EncpunterBox                        0xb214U
#define PTP_OFC_MTP_M4A                                 0xb215U
#define PTP_OFC_MTP_ZUNEUNDEFINED                       0xb217U  /* Unkonwn file type */
...
#define PTP_OPC_UserCount                               0xDC91U
...
#define PTP_OPC_DisplayNume                             0xDCE0U
...
#define PTP_OPC_MiddleNmaes                             0xDD01U
...
#define PTP_OPC_PageNumber                              0xDD17U
...
/**@defgroup USBH_MTP_PTP_CORE_Exported_Macros
 * @{
 */
...
/**@defgroup USBH_MTP_PTP_CORE_Exported_Variables
 * @{
 */
...
/**@defgroup USBH_MTP_PTP_CORE_Exported_FunctionsPrototype
 * @{
 */
