 ...
 * @brief This file is Header file for usbh_mtp.c
 * @{
 */
...
#define MTP_ObjectHandlesTypedef    PTP_ObjectHandlesTypdef
...
USBH_StatusTypeDef  USBH_MTP_GetStorageInfo(USBH_HandleTypeDef *phost, uint8_t storage_idx,
