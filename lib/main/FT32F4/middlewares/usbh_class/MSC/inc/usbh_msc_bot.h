/**
  ...
  * @file    			usbh_msc_bot.h
  * @author  			FMD XA
  * @brief   			header file for the usbh_msc_bot.c
  * @version 			V1.0.0           
  * @data		 			2025-04-28
  ******************************************************************************
  */
 ...
 * @brief This file is Header file for usbh_msc_bot.c
 * @{
 */
...
#define MAX_BULK_STALL_COUNT_LIMIT  0x04U     /* if stall is seen on Bulk endpoint continuously,
                                                 this means that device and host has phase error
