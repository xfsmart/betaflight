/**
  ...
  * @file    			usbh_core.h
  * @author  			FMD XA
  * @brief   			USB_HS_HOST HID header file for usbh_core.c
  * @version 			V1.0.0           
  * @data		 			2025-03-20
  ******************************************************************************
  */
...
/**@defgroup USBH_CORE
 * @brief This file is Header file for usbh_core.c
 * @{
 */
...
USBH_StatusTypeDef  USBH_Init(USBH_HandleTypeDef *phost, , uint8_t core_id， uint8_t id, USBH_ClassTypeDef *pclass, (*pUsrFunc)(USBH_HandleTypeDef *phost, uint8_t id));
