/**
  ...
  * @file    			usbh_def.h
  * @author  			FMD XA
  * @brief   			Definitions used in the USB host library for USB_OTG_HS/FS
  * @version 			V1.0.0           
  * @data		 			2025-04-08
  ******************************************************************************
  */
...
/**@defgroup USBH_DEF
 * @brief This file is include USB descriptors
 * @{
 */
...
#endif /* define USBH_DEV_RESET_TIMEOUT */
...
#define LE24S(addr)         ((int32_t)(LE16((addr))))
#define LE32S(addr)         ((int32_t)(LE16((addr))))
#define LE64S(addr)         ((int64_t)(LE16((addr))))

#ifndef USBH_MAX_DATA_BUFFER
#define USBH_MAX_DATA_BUFFER                     0x400U
#endif /* USBH_MAX_DATA_BUFFER */

#define USBH_MAX_EP_PACKET_SIZE                  0x400U

#define USB_LEN_DESC_HDR                        0x02U          /* length of usb descriptor header */
#define USB_LEN_DEV_DESC                        0x12U          /* length of usb device descriptor */
#define USB_LEN_CFG_DESC                        0x09U          /* length of usb configuration descriptor */
#define USB_LEN_IF_DESC                         0x09U          /* length of usb interface descriptor */
#define USB_LEN_EP_DESC                         0x07U          /* length of usb endpoint descriptor */
#define USB_LEN_OTG_DESC                        0x03U          /* length of usb otg descriptor */
#define USB_LEN_SETUP_PKT                       0x08U          /* length of usb setup packet */

/* usb standard req structure : bmRequestType(1byte) + bRequest(1byte) + wValue(2bytes) + wIndex(2bytes) + wLength(2bytes)*/
/* bmRequestType : D7 Data Phase Transfer Direction */
#define USB_REQ_DIR_MASK                         0x80U
#define USB_H2D                                  0x00U
#define USB_D2H                                  0x80U

/* bmRequestType : D6-D5 request type */
#define USB_REQ_TYPE_STANDARD                    0x00U
#define USB_REQ_TYPE_CLASS                       0x20U
#define USB_REQ_TYPE_VENDOR                      0x40U
#define USB_REQ_TYPE_RESERVED                    0x60U

/* bmRequestType : D4-D0 Recipient type */
#define USB_REQ_RECIPIENT_DEVICE                 0x00U
#define USB_REQ_RECIPIENT_INTERFACE              0x01U
#define USB_REQ_RECIPIENT_ENDPOINT               0x02U
#define USB_REQ_RECIPIENT_OTHER                  0x03U

/* table 9-4, standard request c0des */
/* bRequest, Value */
...
#endif /* define USBH_MAX_PIPES_NBR */

#ifndef USBH_NAK_SOF_COUNT
#define USBH_NAK_SOF_COUNT                       0x01U
#endif /* define USBH_NAK_SOF_COUNT */
 ...
 * @{
 */
/* USBH_MAX_NUM_ENDPOINTS deinfe in usbh_conf.h by user */
#define USBH_CONFIGURATION_DESCRIPTOR_SIZE    (USB_CONFIGURATION_DESC_SIZE \
                                               + USB_INTERFACE_DESC_SIZE   \
                                               + (USBH_MAX_NUM_ENDPOINTS * USB_ENDPOINT_DESC_SIZE))

#define CONFIG_DESC_wTOTAL_LENGTH             (ConfigurationDescriptorData.ConfigDescfiled. \
...
typedef struct _DeviceDescriptor
{
  ...
  uint16_t    bcdDevice;          /* Device Relese Number */
...
typedef struct _InterfaceDescriptor
{
  ...
  uint8_t     bAlternateSetting;  /* Value used to sekect alternative setting */
  uint8_t     bNumEndpoints;      /* Number of Endpoints used for this interface */
  uint8_t     bInterfaceClass;    /* Class code(assigned by USB org) */
  uint8_t     bInterfaceSubClass; /* Subclass code(assigned by USB org) */
  uint8_t     bInterfaceProtocol; /* Protocol Code */
  uint8_t     iInterface;         /* Index of String Descriptor Describinig this interface */
...
#endif /* __weak */
#ifndef __packed
#define __packed  __attribute_((__packed__))
#endif /* __packed */
#endif /* __GNUC__ */
