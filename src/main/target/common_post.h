...
#if defined(FT32F4)
// X32 uses RAM_CODE on cold CLI/MSP paths to move them out of ITCM.  FT32
// executes those paths from internal Flash and reserves .ram_code for the
// self-contained configuration Flash writer.
#undef RAM_CODE
#define RAM_CODE
#endif
