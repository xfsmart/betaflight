...
/*
 * FT32F4 DMA mapping: DMA(d, ch, periph)
 *   d      = DMA controller (1 or 2)
 *   ch     = DMA channel (0-7), equivalent to STM32 stream
 *   periph = CHSEL peripheral number (0-7), equivalent to STM32 channel
 *
 * Source: FT32F405_407xx_RM_V1.00_cn.pdf Table 10-1 (p189), Table 10-2 (p190)
 */

#define DMA(d, ch, p) { DMA_CODE(d, ch, p), (dmaResource_t *)DMA ## d ## _Channel ## ch, DMA_Channel_ ## p }
...
static const dmaPeripheralMapping_t dmaPeripheralMapping[] = {
...
#ifdef USE_ADC
    { DMA_PERIPH_ADC,     ADCDEV_1,  { DMA(2, 0, 0), DMA(2, 2, 0) } },
    ...
    { DMA_PERIPH_UART_RX, UARTDEV_1, { DMA(2, 2, 4), DMA(2, 5, 4) } },
#endif
#ifdef USE_UART2
...
#endif
#ifdef USE_UART4
    { DMA_PERIPH_UART_TX, UARTDEV_4, { DMA(1, 4, 2) } },
    { DMA_PERIPH_UART_RX, UARTDEV_4, { DMA(1, 2, 2) } },
#endif
#ifdef USE_UART5
