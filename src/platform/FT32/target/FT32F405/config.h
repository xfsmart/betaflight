...
/*
 * Canonical FT32F405 production profile. Keep the hardware resources that
 * completed integration testing unchanged when promoting the generic target.
 */
...
#define TARGET_ADC_INSTANCE            ADC3
